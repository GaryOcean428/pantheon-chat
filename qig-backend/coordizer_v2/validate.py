...
After generating the resonance bank, we must verify that the
...
If validation fails, the generation pipeline has
a geometric defect.
"""
...
def _measure_kappa(
    ...
    # signal that the generation pipeline has a defect.
