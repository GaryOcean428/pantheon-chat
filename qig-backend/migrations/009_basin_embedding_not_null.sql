...
-- ============================================================================
-- 
-- Purpose: Prevent NULL basin_embedding contamination in coordizer_vocabulary
-- 
...
--
-- WARNING: This migration assumes coordizer_vocabulary table exists.
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'Migration 009 requires coordizer_vocabulary table. Run vocabulary schema first.';
    END IF;
END $$;
