        ...
        if self.kernel_persistence:
            try:
                self.kernel_persistence.save_kernel_snapshot(
                    ...
                    generation=kernel.profile.generation,
                    basin_coords=kernel.profile.basin_coords,
                    phi=kernel.profile.phi,
                    kappa=kernel.profile.kappa,
                    regime=kernel.profile.regime,
                    kernel_kind="god",
                    success_count=kernel.profile.success_count,
                    failure_count=kernel.profile.failure_count,
                    metadata={
                        'graduated': True,
