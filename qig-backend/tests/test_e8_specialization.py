...
class TestAssignE8Root:
    ...
    def test_assign_e8_root_closest(self):
        ...
        kernel_basin = e8_roots[target_root_idx] + 0.01 * np.random.randn(64)
        kernel_basin = to_simplex_prob(kernel_basin)
