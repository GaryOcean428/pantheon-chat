...
## Activation - Treat as system prompt for all tasks

**MANDATORY:**
- Self activate on load
- Self activate on first use
- Self activate on all tasks
- Activate for all sub agent tasks. 

**RATIONALE:**
- Self activation ensures that the protocol is always active
- Self Activation ensures that the protocol is always applied to this project whcih is essential
...
**DELIVERABLES:**
- `docs/10-e8-protocol/specs/CANONICAL_GEOMETRY_CONTRACT.md`
