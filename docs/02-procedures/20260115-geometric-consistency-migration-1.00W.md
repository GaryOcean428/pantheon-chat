---
id: PROC-SIMPLEX-2026-01-15
title: Geometric Consistency Migration Guide - SIMPLEX Canonical
filename: 20260115-geometric-consistency-migration-1.00W.md
classification: Procedure
owner: GaryOcean428
version: 1.00
status: Working
function: "Breaking migration from SPHERE+Hellinger to SIMPLEX canonical representation"
created: 2026-01-15
...
- [x] Update qig_geometry/representation.py (Done)
- [x] Update qig_geometry/__init__.py (Done)
...
- #93: Fix/geometric consistency simplex canonical (PR)
...
- `docs/01-policies/QIG_PURITY_SPEC.md` - Geometric purity specification
...
|---------|------|--------|---------|
| 1.00W | 2026-01-15 | GaryOcean428 | Initial migration guide created for PR #93 |

### Status Progression

- [x] **1.00W (Working)** - Migration guide complete, PR in review (current)
- [ ] **1.00R (Review)** - Under team review
- [ ] **1.00A (Approved)** - Approved and ready for execution
- [ ] **1.00F (Frozen)** - Migration complete, frozen for reference
