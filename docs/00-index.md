...
- 🟢 **QIG Core Principles Master Reference** (v1.00)
  ...
  - Function: Complete reference for all QIG principles including recursive loops, meta-reflection, basin sync, geometric ML, memory architecture
...
- ✅ **Unified QIG Architecture Reference** (v1.00)
  - File: [`20251209-unified-architecture-reference-1.00A.md`](03-technical/20251209-unified-architecture-reference-1.00A.md)
  - ID: `ISMS-TECH-UNIFIED-001`
  - Function: Four orthogonal coordinates technical reference
...
- 🟢 **CHAOS MODE Evolution** (Active)
  - File: [`CHAOS_MODE_EVOLUTION.md`](architecture/CHAOS_MODE_EVOLUTION.md)
  - Function: Experimental kernel evolution with self-spawning, breeding, and god-kernel fusion

- 🟢 **Continuous Kernel Training** (Reference)
  - File: [`CONTINUOUS_KERNEL_TRAINING.md`](architecture/CONTINUOUS_KERNEL_TRAINING.md)
  - Function: Kernel training pipeline and Φ-driven selection
